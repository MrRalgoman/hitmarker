...
local function loadAddon()
	...
	if ( SERVER ) then
		...
		AddCSLuaFile "hitmarker/client/vgui/hit_pnl.lua"
		AddCSLuaFile "hitmarker/client/vgui/dmg_pnl.lua"
	...
	elseif ( CLIENT ) then
		...
		include "hitmarker/client/vgui/hit_pnl.lua"
		include "hitmarker/client/vgui/dmg_pnl.lua"
	end
end
